              ...
              <table className="concert-table">
                ...
                <a href = "https://www.doerken-stiftung.de/werner-richard-saal-veranstaltungen/weitere-veranstaltungen/oeffentliches-vorspiel-fuer-ein-musikstipendium-der-stiftung/" target="_blank">
                    <tr>
                        <td>
                            <span className="concert-first-title">
                            {this.state.LANGUAGE.t('concert_52_date')}
                            </span>
                            <span className="concert-second-title">
                            {this.state.LANGUAGE.t('concert_52_place')}
                            </span>
                        </td>
                        <td>{this.state.LANGUAGE.t('concert_52_city')}</td>
                        <td>{this.state.LANGUAGE.t('concert_52_event')}</td>
                        <td>{this.state.LANGUAGE.t('concert_52_additional')}</td>
                    </tr>
                 </a>
                <a href = "https://burg-vischering.de/veranstaltung/maiklang-duo-weles/" target="_blank">
                    <tr>
                        <td>
                            <span className="concert-first-title">
                            {this.state.LANGUAGE.t('concert_51_date')}
                            </span>
                            <span className="concert-second-title">
                            {this.state.LANGUAGE.t('concert_51_place')}
                            </span>
                        </td>
                        <td>{this.state.LANGUAGE.t('concert_51_city')}</td>
                        <td>{this.state.LANGUAGE.t('concert_51_event')}</td>
                        <td>{this.state.LANGUAGE.t('concert_51_additional')}</td>
                    </tr>
                 </a>
                <a>
                    <tr>
                        <td>
                            <span className="concert-first-title">
                            {this.state.LANGUAGE.t('concert_50_date')}
                            </span>
                            <span className="concert-second-title">
                            {this.state.LANGUAGE.t('concert_50_place')}
                            </span>
                        </td>
                        <td>{this.state.LANGUAGE.t('concert_50_city')}</td>
                        <td>{this.state.LANGUAGE.t('concert_50_event')}</td>
                        <td>{this.state.LANGUAGE.t('concert_50_additional')}</td>
                    </tr>
                 </a>
                <a>
                    <tr>
